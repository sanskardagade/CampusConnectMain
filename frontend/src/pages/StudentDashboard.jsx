  ...
  useEffect(() => {
    const fetchStudentData = async () => {
      try {
        ...
        const profileResponse = await fetch('http://82.112.238.4:5000/api/students/profile', {
          headers: {
        ...
        const attendanceResponse = await fetch('http://82.112.238.4:5000/api/students/attendance', {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`
          }
        });
        ...
        const overallResponse = await fetch('http://82.112.238.4:5000/api/students/attendance/overall', {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`
          }
        });
