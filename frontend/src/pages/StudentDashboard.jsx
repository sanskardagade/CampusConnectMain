  ...
  useEffect(() => {
    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const dashboardResponse = await fetch('http://69.62.83.14:9000/api/student/dashboard', {
          headers: {
        ...
        const attendanceResponse = await fetch('http://69.62.83.14:9000/api/student/attendance', {
          headers: {
            'Authorization': `Bearer ${token}`
          }
        });
