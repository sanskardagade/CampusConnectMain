...
const PrincipalDashboard = () => {
  ...
  const fetchPendingLeaves = async () => {
    try {
      ...
      const [normalRes, shortRes] = await Promise.all([
        axios.get('http://82.112.238.4:5000/api/principal/faculty-leave-approval', { headers: { Authorization: `Bearer ${token}` } }),
        axios.get('http://82.112.238.4:5000/api/principal/short-leaves', { headers: { Authorization: `Bearer ${token}` } })
      ]);
  ...
  const fetchTodayPresence = async () => {
    try {
      const token = localStorage.getItem('token');
      // Faculty logs
      const facultyRes = await axios.get('http://82.112.238.4:5000/api/principal/faculty-logs', {
        headers: { Authorization: `Bearer ${token}` }
      });
      ...
      // Staff logs
      const staffRes = await axios.get('http://82.112.238.4:5000/api/principal/staff-logs', {
        headers: { Authorization: `Bearer ${token}` }
      });
      ...
      const studentRes = await axios.get('http://82.112.238.4:5000/api/principal/student-attendance-today', {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const fetchPresentFacultyStaffSummary = async () => {
    try {
      const token = localStorage.getItem('token');
      const res = await axios.get('http://82.112.238.4:5000/api/principal/present-faculty-staff-summary', {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const fetchAllMembers = async () => {
    try {
      ...
      const response = await axios.get(
        'http://82.112.238.4:5000/api/principal/all-members',
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const fetchDepartmentMembers = async (deptId, type) => {
    try {
      ...
      const token = localStorage.getItem('token');
      const response = await axios.get(
        `http://82.112.238.4:5000/api/principal/members?deptId=${deptId}&type=${type}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
      setMembers(response.data.members);
  ...
  const fetchMemberProfile = async (memberId) => {
    try {
      ...
      const token = localStorage.getItem('token');
      const response = await axios.get(
        `http://82.112.238.4:5000/api/principal/profile/${memberId}?type=${selectedType}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
      ...
      if (selectedType === 'faculty') {
        ...
        try {
          const logsRes = await axios.get(
            `http://82.112.238.4:5000/api/principal/faculty-logs/${memberId}`,
            { headers: { Authorization: `Bearer ${token}` } }
          );
        ...
        try {
          const logsRes = await axios.get(
            `http://82.112.238.4:5000/api/principal/staff-logs/${memberId}`,
            { headers: { Authorization: `Bearer ${token}` } }
          );
  ...
  const handleDownloadAttendance = async (format) => {
    ...
    try {
        const token = localStorage.getItem('token');
        const response = await axios.get('http://82.112.238.4:5000/api/principal/faculty-attendance-report', {
            headers: { Authorization: `Bearer ${token}` },
  ...
  const fetchPresentFacultyList = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const res = await axios.get('http://82.112.238.4:5000/api/principal/present-faculty-today', {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const fetchPresentStaffList = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const res = await axios.get('http://82.112.238.4:5000/api/principal/present-staff-today', {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const fetchFacultyDeptTotals = async () => {
    try {
      const token = localStorage.getItem('token');
      const res = await axios.get('http://82.112.238.4:5000/api/principal/faculty-department-counts', {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const fetchStaffDeptTotals = async () => {
    try {
      const token = localStorage.getItem('token');
      const res = await axios.get('http://82.112.238.4:5000/api/principal/staff-department-counts', {
        headers: { Authorization: `Bearer ${token}` }
      });
      // Convert to map: { department_id: count }
      const map = {};
  ...
  const handlePreviewStaffPdf = async (deptId) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const today = dayjs().format('YYYY-MM-DD');
      const response = await axios.get('http://82.112.238.4:5000/api/principal/staff-attendance-report', {
        headers: { Authorization: `Bearer ${token}` },
        params: { departmentId: deptId, format: 'pdf', fromDate: today, toDate: today },
        responseType: 'blob',
      });
