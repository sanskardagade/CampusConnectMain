...
const SecurityDashboard = () => {
  ...
  const fetchLeaves = async () => {
    ...
    setError('');
    try {
      const res = await axios.get('https://82.112.238.4:5000/api/registrar/security-dashboard', {
  ...
  const fetchDebugData = async () => {
    try {
      const res = await axios.get('https://82.112.238.4:5000/api/registrar/security-dashboard/debug');
  ...
  const fetchFacultyStatus = async (erpId) => {
    try {
      const res = await axios.get(`https://82.112.238.4:5000/api/registrar/security-dashboard/status/${erpId}`);
  ...
  const fetchExitedToday = async () => {
    try {
      const res = await axios.get('https://82.112.238.4:5000/api/registrar/security-dashboard/exited-today');
  ...
  const handleMarkExit = async (erpStaffId) => {
    ...
    setError('');
    try {
      const r = await axios.post('https://82.112.238.4:5000/api/registrar/security-dashboard/exit', { erpStaffId });
  ...
  const handleUnmarkExit = async (erpStaffId) => {
    ...
    setError('');
    try {
      const r = await axios.post('https://82.112.238.4:5000/api/registrar/security-dashboard/unexit', { erpStaffId });
