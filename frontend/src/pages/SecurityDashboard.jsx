...
const SecurityDashboard = () => {
  ...
  const fetchFacultyOnLeave = async () => {
    ...
    try {
      ...
      const res = await axios.get('http://69.62.83.14:5000/api/registrar/security-dashboard', { params: { date } });
      let data = res.data;
  ...
  const handleMarkExit = async (erpStaffId) => {
    ...
    setSuccess('');
    try {
      await axios.post('http://69.62.83.14:5000/api/registrar/security-dashboard/exit', { erpStaffId });
  ...
  const confirmEditExit = async () => {
    ...
    try {
      await axios.post('http://69.62.83.14:5000/api/registrar/security-dashboard/unexit', { erpStaffId: editErpId });
