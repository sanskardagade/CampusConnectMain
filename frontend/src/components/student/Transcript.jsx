...
export default function Transcript() {
  ...
  const fetchTranscripts = async () => {
    try {
      ...
      const res = await fetch("https://82.112.238.4:5000/api/students/transcripts", {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const token = localStorage.getItem("token");
      const res1 = await fetch("https://82.112.238.4:5000/api/students/transcript", {
        method: "POST",
        headers: { Authorization: `Bearer ${token}` },
        body: data,
      });
      ...
      const res2 = await fetch("https://82.112.238.4:5000/api/students/transcript-details", {
        method: "POST",
        headers: {
