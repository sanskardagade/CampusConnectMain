...
export default function Transcript() {
  ...
  const fetchTranscripts = async () => {
    try {
      ...
      const res = await fetch("https://api.antryx.in/api/students/transcripts", {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const token = localStorage.getItem("token");
      const res1 = await fetch("https://api.antryx.in/api/students/transcript", {
        method: "POST",
        headers: { Authorization: `Bearer ${token}` },
        body: data,
      });
      ...
      const res2 = await fetch("https://api.antryx.in/api/students/transcript-details", {
        method: "POST",
        headers: {
