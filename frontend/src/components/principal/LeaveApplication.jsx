...
export default function LeaveApplication() {
  ...
  useEffect(() => {
    const fetchShortLeavesHodPending = async () => {
      try {
        const res = await axios.get('https://api.antryx.in/api/principal/short-leaves', {
  ...
  useEffect(() => {
    const fetchLeaveApplications = async () => {
      try {
        const response = await axios.get('https://api.antryx.in/api/principal/faculty-leave-approval', {
          headers: {
  ...
  const handleApprove = async (application) => {
    ...
    try {
      const response = await axios.put(
        `https://api.antryx.in/api/principal/faculty-leave-approval/${application.ErpStaffId}`,
  ...
  const handleReject = async () => {
    ...
    try {
      const response = await axios.put(
        `https://api.antryx.in/api/principal/faculty-leave-approval/${selectedApplication.ErpStaffId}`,
