...
const HODProfileEdit = () => {
      ...
      <div className="min-h-screen bg-gray-100 text-white flex items-center justify-center p-6">
        <div className="bg-red-900 w-full max-w-2xl rounded-xl shadow-md p-8">
          <div className="animate-pulse">
            <div className="h-8 bg-red-800 rounded w-1/3 mx-auto mb-6"></div>
            <div className="space-y-4">
              <div className="h-10 bg-red-800 rounded"></div>
              <div className="h-10 bg-red-800 rounded"></div>
              <div className="h-10 bg-red-800 rounded"></div>
            </div>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-white flex items-center justify-center p-6">
      <div className="bg-red-900 w-full max-w-2xl rounded-xl shadow-md p-8">
        <h2 className="text-2xl font-bold mb-6 text-center">Edit HOD Profile</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-between mt-6">
            ...
            <button
              type="submit"
              className="bg-white text-red-900 font-semibold px-6 py-2 rounded hover:bg-red-100 transition disabled:opacity-50"
              disabled={loading}
            >
...
const InputField = ({ label, name, value, onChange, type = 'text', required = false, disabled = false }) => (
  <div>
    ...
    <input
      ...
      required={required}
      disabled={disabled}
      className="w-full px-4 py-2 rounded bg-white text-red-900 border border-red-300 focus:outline-none focus:ring-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed"
    />
  </div>
);
