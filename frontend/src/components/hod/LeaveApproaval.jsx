...
export default function LeaveApprovalDashboard() {
  ...
  useEffect(() => {
    const fetchLeaveApplications = async () => {
      try {
        const response = await axios.get('http://69.62.83.14:5000/api/hod/leave-approval');
  ...
  const handleApprove = async (application) => {
    ...
    try {
      const response = await axios.put(`http://69.62.83.14:5000/api/hod/leave-approval/${application.ErpStaffId}`, {
