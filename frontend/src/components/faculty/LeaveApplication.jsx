...
export default function LeaveApplication() {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        const response = await fetch(`https://api.antryx.in/api/faculty/dashboard?date=${today}`, {
          headers: {
  ...
  useEffect(() => {
    const fetchLeaveApplications = async () => {
      try {
        const response = await fetch('https://api.antryx.in/api/faculty/leave-apply', {
          headers: {
            'Authorization': `Bearer ${token}`
          }
        });
  ...
  useEffect(() => {
    const fetchLeaveBalances = async () => {
      try {
        const response = await fetch('https://api.antryx.in/api/faculty/leave-balances', {
          headers: {
            'Authorization': `Bearer ${token}`
          }
        });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const applicationsResponse = await fetch('https://api.antryx.in/api/faculty/leave-apply', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
