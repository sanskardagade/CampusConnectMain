...
const Todo = () => {
  ...
  const fetchTasks = async () => {
    try {
      ...
      const response = await fetch('http://82.112.238.4:5000/api/faculty/todo', {
        headers: {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const url = editingTask
        ? `http://82.112.238.4:5000/api/faculty/todo/${editingTask.task_id}`
        : 'http://82.112.238.4:5000/api/faculty/todo';
  ...
  const handleDelete = async (taskId) => {
    ...
    try {
      ...
      const response = await fetch(`http://82.112.238.4:5000/api/faculty/todo/${taskId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
        },
  ...
  const toggleTaskStatus = async (task) => {
    ...
    try {
      ...
      const response = await fetch(`http://82.112.238.4:5000/api/faculty/todo/${task.task_id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
