...
const FacultyManagement = () => {
  ...
  const fetchFaculty = async () => {
    try {
      ...
      const response = await axios.get('https://api.antryx.in/api/registrar/faculty', {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editingFaculty 
        ? `https://api.antryx.in/api/registrar/faculty/${editingFaculty.id}`
        : 'https://api.antryx.in/api/registrar/faculty';
  ...
  const handleDelete = async (id, name) => {
    ...
    try {
      const token = localStorage.getItem('token') || sessionStorage.getItem('token');
      const response = await axios.delete(`https://api.antryx.in/api/registrar/faculty/${id}`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
