  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-[#b22b2f] mb-2">Staff Management</h1>
          <p className="text-gray-600">Manage non-teaching staff members and their information</p>
        </div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-3xl font-bold text-[#b22b2f]">{staff.length}</p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
