      ...
      if (reportType === 'attendance') {
        if (attendanceStatus === 'present') {
          endpoint = attendanceType === 'faculty'
            ? 'http://69.62.83.14:5000/api/registrar/faculty-attendance-report'
            : 'http://69.62.83.14:5000/api/registrar/staff-attendance-report';
        } else {
          endpoint = attendanceType === 'faculty'
            ? 'http://69.62.83.14:5000/api/registrar/absent-faculty-today'
            : 'http://69.62.83.14:5000/api/registrar/absent-staff-today';
        }
      } else if (reportType === 'stress') {
        endpoint = stressType === 'faculty'
          ? 'http://69.62.83.14:5000/api/registrar/faculty-stress-report'
          : 'http://69.62.83.14:5000/api/registrar/staff-stress-report';
      } else if (reportType === 'leave') {
        endpoint = 'http://69.62.83.14:5000/api/registrar/faculty-leave-report';
      }
