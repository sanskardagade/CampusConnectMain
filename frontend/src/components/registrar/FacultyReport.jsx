      ...
      if (reportType === 'attendance') {
        if (attendanceStatus === 'present') {
          endpoint = attendanceType === 'faculty'
            ? 'http://82.112.238.4:5000/api/registrar/faculty-attendance-report'
            : 'http://82.112.238.4:5000/api/registrar/staff-attendance-report';
        } else {
          endpoint = attendanceType === 'faculty'
            ? 'http://82.112.238.4:5000/api/registrar/absent-faculty-today'
            : 'http://82.112.238.4:5000/api/registrar/absent-staff-today';
        }
      } else if (reportType === 'stress') {
        endpoint = stressType === 'faculty'
          ? 'http://82.112.238.4:5000/api/registrar/faculty-stress-report'
          : 'http://82.112.238.4:5000/api/registrar/staff-stress-report';
      } else if (reportType === 'leave') {
        endpoint = 'http://82.112.238.4:5000/api/registrar/faculty-leave-report';
      }
